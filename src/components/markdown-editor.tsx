...
/** 与新建记录一致的 Markdown 编辑器：工具栏 + 实时渲染，输出为 Markdown 字符串 */
export function MarkdownEditor({
  ...
  return (
    <div className={["overflow-hidden rounded-xl border border-[var(--line)] bg-[var(--surface)]", className].filter(Boolean).join(" ")}>
      {editor && (
        <div className="flex flex-wrap items-center gap-0.5 border-b border-[var(--line)] bg-[var(--surface)] px-3 py-1.5">
          ...
          <FmtBtn active={editor.isActive("strike")} onClick={() => editor.chain().focus().toggleStrike().run()} title="删除线">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <path d="M17.5 7.5c0-2-1.5-3.5-5.5-3.5S6 5 6 7.5c0 4 12 2 12 7.5 0 2.5-2.5 4-6 4s-6-1.5-6-4" />
            </svg>
          </FmtBtn>
